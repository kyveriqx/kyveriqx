...
/* "Connect your mailbox" — shown when the user has no sending method yet, or
   ...
   The mailbox connection is shared with Email Campaigns (both are keyed by
   user), so connecting here also powers email campaigns and vice versa.
  ...
  return (
    <Card style={{ padding: 28, maxWidth: 720 }}>
      ...
      <p style={{ color: "var(--ink-300)", fontSize: 14, margin: "0 0 22px", lineHeight: 1.55 }}>
        Reminders are sent <em>from</em> your own mailbox. The quickest way is to
